...
function ProjectForm({ handleSubmit, btnText, projectData }) {
    ...
    return (
        <form onSubmit={submit} className={styles.form}>
            ...
            <SelectCategory name="category_id" text="Selecione a categoria" options={categories} handleOnChange={handleCategory} value={project.category ? project.category.id : ''}/>
